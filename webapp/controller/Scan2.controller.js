    ...
    return Controller.extend("ventilado.ventilado.controller.Scan2", {
        ...
        if (oModel.getProperty("/ruta") == 0) {
          ...
          if (ruta) {
            ...
            if (ruta == oModel.getProperty("/ruta")) {
              ...
              var cantidadAEscanear =
                parseInt(oModel.getProperty("/cantidadAEscanear")) || 1; // Asegúrate de no dividir por cero
              ...
              request.onsuccess = function (event) {
                ...
                var resultadoFormateadoM3r = resultadoM3r
                  .toFixed(3)
                  .padStart(5, " ");
                ...
                // Formatear el resultado para que tenga longitud 5
                var resultadoFormateadoKgbrr = resultadoKgbrr
                  .toFixed(1)
                  .padStart(5, " ");
              ...
              MessageBox.error(
                "Error : Esta confirmando en una ruta equivocada, tiene que hacelo en la ruta " +
                  oModel.getProperty("/ruta"),
                {
                  title: "Error ",
                  styleClass: "customMessageBox", // Aplica la clase CSS personalizada
                  onClose: function () {
      ...
      onStopConfirm: function () {
        ...
        aItems.forEach(function (oItem, index) {
          ...
          var cubetas = Number(oCells[7].getValue()) || 0;
          var pallets = Number(oCells[8].getValue()) || 0;
          var rolls = Number(oCells[9].getValue()) || 0;
