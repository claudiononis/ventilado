		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ventilado",
									"targetURL": "#ventiladoventilado-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ventiladoventilado-display": {
								"semanticObject": "ventiladoventilado",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ventilado.ventilado",
									"url": sap.ui.require.toUrl("ventilado/ventilado")
								}
							}
						}
					}
